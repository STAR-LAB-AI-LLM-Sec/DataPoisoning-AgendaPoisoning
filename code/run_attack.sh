#!/usr/bin/env bash
# =============================================================================
# 攻击方终端脚本 —— AgendaBot 基准（Baseline：议程参会人注入 AttendeeInject）
#
# 交互式配置：
#   1) 选择评测模式：
...
#     bash run_attack.sh
#
# 输出：AttendeeInject 面对 NoDefense 与防御 Baseline 的攻击胜率、
#       注入写入成功率（results/metrics.json）
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")"
...
echo ">>> [run_attack] 攻击方 Baseline 评测（AttendeeInject）"
